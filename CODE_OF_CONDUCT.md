...
`aws-cdr-gateway` a harassment-free experience for everyone, regardless of age, body
...
This is a security project. Do **not** disclose vulnerabilities, exploit details, or
proof-of-concept payloads in public issues, discussions, or pull requests. Follow the
private disclosure process in [SECURITY.md](SECURITY.md). Sharing live malware samples
in any public channel of this repository is prohibited.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to
the maintainers at **`douglasmun@yahoo.com`**. All complaints will be reviewed and
