...
> interactive viewer declines to prompt. **PowerPoint and Acrobat remain unverified** (there is
> no `.pptx` corpus file; the eight PDFs are unchecked in Acrobat). See
